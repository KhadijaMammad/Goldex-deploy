...
export function CreditSettings() {
    ...
    async function saveSettings() {
        ...
        try {
            ...
            await axios.put(`${API_URL}/credit_options`, updates);

            alert('Kredit parametrləri uğurla yeniləndi! ✅');
        } catch (err) {
            console.error('Error saving settings:', err);
            alert('Xəta baş verdi! Parametrlər yadda saxlanılmadı. ❌');
        } finally {
            setSaving(false);
        }
    }
